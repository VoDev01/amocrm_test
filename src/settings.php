<?php
define('C_REST_CLIENT_ID','local.686bff01a073d6.87663435');//Application ID
define('C_REST_CLIENT_SECRET','B3MT6YVAc0HxpWA1AJzfG5dUSd8YVgh9N8rRSJzsgJLRXy1SWF');//Application key
// or
